        ...
        public static void BuildAndRegister()
        {
            Character = new CharacterDataBuilder
            {
                ...
                CharacterChatterData = new CharacterChatterDataBuilder 
                {
                    ...
                    {
                        "Beyonder_Unit_Malevolence_Chatter_Key_Attacking_0",
                        "Beyonder_Unit_Malevolence_Chatter_Key_Attacking_1",
                        "Beyonder_Unit_Malevolence_Chatter_Key_Attacking_2",
                        "Beyonder_Unit_Malevolence_Chatter_Key_Attacking_3"
                    },
