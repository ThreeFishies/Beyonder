...
namespace Void.Mania
{
    ...
    public class TrackAlliesSacrificed : ExtendedEnum<TrackAlliesSacrificed, CardStatistics.TrackedValueType>
    {
        // Token: 0x06000106 RID: 262 RVA: 0x00005CDC File Offset: 0x00003EDC
        public TrackAlliesSacrificed(string localizationKey, int? ID = null) : base(localizationKey, ID ?? TrackAlliesSacrificed.GetNewTooltipTypeGUID())
        {
        }
        ...
        {
            TrackAlliesSacrificed.NumTypes++;
            return TrackAlliesSacrificed.NumTypes;
        }

        // Token: 0x06000108 RID: 264 RVA: 0x00005D44 File Offset: 0x00003F44
        public static implicit operator TrackAlliesSacrificed(CardStatistics.TrackedValueType trackedValue)
        {
            return ExtendedEnum<TrackAlliesSacrificed, CardStatistics.TrackedValueType>.Convert(trackedValue);
        }

        // Token: 0x0400016E RID: 366
        // 37 is next in the list.
        private static int NumTypes = 36;
    ...
    public static class AddTrackAlliesSacrificed
    {
