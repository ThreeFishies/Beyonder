...
{
    public static class SeedOfDoubt
    {
        public static CollectableRelicData Artifact;
        public static string ID = "SeedOfDoubt_" + Beyonder.GUID;
        ...
        public static CollectableRelicData BuildAndRegister()
        {
            Artifact = new CollectableRelicDataBuilder
            {
                ...
                NameKey = "Beyonder_Artifact_SeedOfDoubt_Name_Key",
                DescriptionKey = "Beyonder_Artifact_SeedOfDoubt_Description_Key",
                RelicLoreTooltipKeys = new List<string>
                {
                    "Beyonder_Artifact_SeedOfDoubt_Lore_Key"
                },
                IconPath = "ArtifactAssets/SeedOfDoubt.png",
                ...
                EffectBuilders = new List<RelicEffectDataBuilder>
                {
                    ...
                    {
                        RelicEffectClassName = "RelicEffectAddStatusEffectOnEnterRoomIndex",
                        ParamInt = 2,
